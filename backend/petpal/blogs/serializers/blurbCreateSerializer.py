...
from ..models import Blurb, Blog
from accounts.models import ShelterProfile

class BlurbCreateSerializer(serializers.ModelSerializer):

    class Meta:
        model = Blurb
        fields = ('content', 'content_type', 'index')
    ...
    def create(self, validated_data):
        ...
        blurb = Blurb.objects.create(**validated_data)
        return blurb